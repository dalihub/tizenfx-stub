 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_set_app_context_event_cb(app_manager_app_context_event_cb callback, void *user_data);
 ...
 * @see app_manager_app_context_event_cb()
 */
TIZENFX_STUB_API void STDCALL app_manager_unset_app_context_event_cb(void);
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_foreach_app_context(app_manager_app_context_cb callback, void *user_data);
 ...
 * @see app_manager_app_context_cb()
 */
TIZENFX_STUB_API int STDCALL app_manager_foreach_running_app_context(app_manager_app_context_cb callback, void *user_data);
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_get_app_context(const char *app_id, app_context_h *app_context);
 ...
 * @retval  #APP_MANAGER_ERROR_OUT_OF_MEMORY      Out of memory
 */
TIZENFX_STUB_API int STDCALL app_manager_get_app_id(pid_t pid, char **app_id);
 ...
 * @retval  #APP_MANAGER_ERROR_INVALID_PARAMETER  Invalid parameter
 */
TIZENFX_STUB_API int STDCALL app_manager_is_running(const char *app_id, bool *running);
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_resume_app(app_context_h app_context);
 ...
 * @retval #APP_MANAGER_ERROR_PERMISSION_DENIED Permission denied
 */
TIZENFX_STUB_API int STDCALL app_manager_request_terminate_bg_app(app_context_h app_context);
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_foreach_app_info(app_manager_app_info_cb callback, void *user_data);
 ...
 * @retval  #APP_MANAGER_ERROR_NO_SUCH_APP        No such application
 */
TIZENFX_STUB_API int STDCALL app_manager_get_app_info(const char *app_id, app_info_h *app_info);
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_get_shared_data_path(const char *app_id, char **path);
 ...
 * @retval  #APP_MANAGER_ERROR_OUT_OF_MEMORY      Out of memory
 */
TIZENFX_STUB_API int STDCALL app_manager_get_shared_resource_path(const char *app_id, char **path);
 ...
 * @retval  #APP_MANAGER_ERROR_OUT_OF_MEMORY      Out of memory
 */
TIZENFX_STUB_API int STDCALL app_manager_get_shared_trusted_path(const char *app_id, char **path);
 ...
 * @retval  #APP_MANAGER_ERROR_OUT_OF_MEMORY      Out of memory
 */
TIZENFX_STUB_API int STDCALL app_manager_get_external_shared_data_path(const char *app_id, char **path) TIZEN_DEPRECATED_API;
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_event_create(app_manager_event_h *handle);
 ...
 * @see app_manager_set_event_cb()
 */
TIZENFX_STUB_API int STDCALL app_manager_event_set_status(app_manager_event_h handle, int status_type);
 ...
 * @see app_manager_unset_event_cb()
 */
TIZENFX_STUB_API int STDCALL app_manager_set_event_cb(app_manager_event_h handle,
 ...
 * @see app_manager_set_event_cb()
 */
TIZENFX_STUB_API int STDCALL app_manager_unset_event_cb(app_manager_event_h handle);
 ...
 */
TIZENFX_STUB_API int STDCALL app_manager_event_destroy(app_manager_event_h handle);
 ...
 * @see app_manager_event_create()
 */
TIZENFX_STUB_API int STDCALL app_manager_set_app_icon(const char *app_id, const char *icon_path);
