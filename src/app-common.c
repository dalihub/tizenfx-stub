...
TIZENFX_STUB_API int STDCALL app_get_id(char **id)
{
...
TIZENFX_STUB_API int STDCALL app_get_name(char **name)
{
...
TIZENFX_STUB_API char* STDCALL app_get_resource_path(void)
{
...
TIZENFX_STUB_API char* STDCALL app_get_data_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_cache_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_shared_data_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_shared_resource_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_shared_trusted_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_tep_resource_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_external_cache_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_external_data_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API char* STDCALL app_get_external_shared_data_path(void)
{
  return app_get_resource_path();
}

TIZENFX_STUB_API int STDCALL app_get_version(char** version)
{
  *version = strdup("1.1.1");
  return APP_ERROR_NONE;
}

TIZENFX_STUB_API int STDCALL app_event_get_low_memory_status(app_event_info_h event_info, app_event_low_memory_status_e *status)
{
...
TIZENFX_STUB_API int STDCALL app_event_get_low_battery_status(app_event_info_h event_info, app_event_low_battery_status_e *status)
{
  if (event_info == NULL || status == NULL)
    return APP_ERROR_INVALID_PARAMETER;
...
TIZENFX_STUB_API int STDCALL app_event_get_language(app_event_info_h event_info, char **lang)
{
...
TIZENFX_STUB_API int STDCALL app_event_get_region_format(app_event_info_h event_info, char **region)
{
...
TIZENFX_STUB_API int STDCALL app_resource_manager_get(app_resource_e type, const char *id, char **path)
{
  *path=strdup("/tmp/a");
  return APP_ERROR_NONE;
}

TIZENFX_STUB_API int STDCALL app_event_get_device_orientation(app_event_info_h event_info, app_device_orientation_e *orientation)
{
